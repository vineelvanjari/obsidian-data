 🚀 DSA Multiverse Canvas – Session 01

Today: 6 Problems Solved ✅
...
- LeetCode (Closest – Kth Largest): [https://leetcode.com/problems/kth-largest-element-in-an-array/](https://leetcode.com/problems/kth-largest-element-in-an-array/)
...
### 🚀 Best Version (Same – Already Optimal)

Time Complexity: O(n)  
Space Complexity: O(1)

## Example: [8,2,10,-3,15,12]
### 🧠 Your Version Explanation
...
Flow: 8 → compare 2 → no change 8 → compare 10 → update to 10 10 → compare -3 → no change 10 → compare 15 → update to 15 15 → compare 12 → no change Result = 15


# 2️⃣ Find First and Last Occurrence of K
...
### 🚀 Best Version (Binary Search – Sorted Array)
...
### 🚀 Best Version (Binary Search – Sorted Required)
...
### 🚀 Best Version (Same – Optimal Single Pass)
...
Traversal: 5 → max1=5 3 → max2=3 15 → max1=15, max2=5 12 → max2=12 15 → ignored duplicate 20 → max1=20, max2=15
...
Already optimal – requires full traversal.  
...
Full traversal required. Time Complexity = O(n × m) Optimal already.


---

# 6️⃣ Swap Major and Minor Diagonals
...
Same logic – single loop diagonal swap is optimal.  
Time Complexity: O(n)  
Space Complexity: O(1)
